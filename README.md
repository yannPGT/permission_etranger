...
Le widget comporte les parcours tableau de bord, création/soumission, « Mes actions », complétion du profil, demande de droits, vérification des inscriptions et administration des droits. Les décisions de workflow mettent à jour `Demandes`, `Actions` et `Historique` dans un appel groupé.
